        ...
        <>
            <section id='intro'>
                <div className='introContent'>
                    <span className='hello mt-2 sm:text-2xl md:text-5xl 2xl:text-6xl font-Mooli text-white  tracking-wide'>
                        Hello,
                    </span><br />
                    <span className=' introName sm:text-2xl md:text-5xl text-white font-Dela overflow-clip'>I'm <span className=' text-yellow-300 tracking-wide md:text-5xl xl:text-6xl sm:text-lg'>Dhineshkumar D.</span></span><br />
                    ...
                    <div className=' location'>
                        ...
                        <span className='sm:text-xl text-white md:text-2xl sm:text-yellow-500 lg:text-4xl font-Roboto_Slab tracking-wider overflow-clip'> Krishnagiri, TamilNadu, India
                        </span>
                    </div>
                    <div className='links'>
