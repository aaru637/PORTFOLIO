        ...
        <div className='parent'>
            <div className=' shield'>
                ...
                <div className='content'>
                    ...
                    <p className='mt-2'><span className='font-Exo font-bold'>Source Code : </span><a href='index.html' className=' text-blue-900 font-extrabold'>Click Here</a></p>
                </div>
            </div>
            <div className=' icecream'>
                <img className='mr-3' alt='icecream' src={IceCream} width={100} height={100} />
                <div className='content'>
                    <h2 className=' mt-3 font-Martian'>ICECREAM</h2>
